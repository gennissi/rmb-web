<? 
	...
	if(@$_POST['cmd'] == 'save_marker')
	{
		...
		$marker_radius = $_POST["marker_radius"];
	...
	{ 
		...
		// prevent injection attacks
		if (!isMySQLOrderByValid('gs_user_markers.marker_name', $sord))
		{
			die;
		}
	...
	{ 
		...
		// prevent injection attacks
		if (!isMySQLOrderByValid('gs_user_routes.route_name', $sord))
		{
			die;
		}
	...
	{ 
		...
		// prevent injection attacks
		if (!isMySQLOrderByValid('gs_user_zones.zone_name', $sord))
		{
			die;
		}
