<?
     ...
     if(@$_POST['cmd'] == 'load_server_data')
	{
		...
		$result = array('server_api_key' => $gsValues['SERVER_API_KEY'],
						...
						'map_arcgis' => $gsValues['MAP_ARCGIS'],
						...
						'map_arcgis_key' => $gsValues['MAP_ARCGIS_KEY'],
						...
						'user_map_arcgis' => $gsValues['USER_MAP_ARCGIS'],
						...
						'sim_number' => $gsValues['SIM_NUMBER'],
						'reports_schedule' => $gsValues['REPORTS_SCHEDULE'],
						'object_control_default_templates' => $gsValues['OBJECT_CONTROL_DEFAULT_TEMPLATES'],
						...
						'billing_paypalv2_account' => $gsValues['BILLING_PAYPALV2_ACCOUNT'],
						'billing_paypalv2_client_id' => $gsValues['BILLING_PAYPALV2_CLIENT_ID'],
						'billing_paypalv2_custom' => $gsValues['BILLING_PAYPALV2_CUSTOM'],
						'billing_paypalv2_ipn_url' => $gsValues['URL_ROOT'].'/api/billing/paypal.php',					
