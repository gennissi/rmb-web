<div id="dialog_billing_server" title="<? echo $la['BILLING']; ?>">
	<div class="info">
		Billing allows to view existing Hosted Server plan details and extend it before expiration. Details are updated after payment is confirmed, sometimes it may take a while.
	</div>
