<ul id="dialog_subaccounts_subaccount_list_grid_action_menu" class="menu">
        <li><a class="icon-tick first-item" href="#" onclick="userSubaccountsActivateSelected();"><? echo $la['ACTIVATE'];?></a></li>
        <li><a class="icon-close" href="#" onclick="userSubaccountsDeactivateSelected();"><? echo $la['DEACTIVATE'];?></a></li>
        <li><a class="icon-remove3" href="#" onclick="userSubaccountsDeleteSelected();"><? echo $la['DELETE'];?></a></li>
</ul>
