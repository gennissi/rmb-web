...
<html>
	<head>
		...
		<? if (file_exists('config.hosting.php') || @file_exists('../config.hosting.php')) {
			if (file_exists('mod/billingserver/gs.cpanel.billingserver.js')) { ?>
			<script type="text/javascript" src="mod/billingserver/gs.cpanel.billingserver.js?v=<? echo $gsValues['VERSION_ID']; ?>"></script>
		<? }} ?>
	</head>
	...
	<body id="cpanel" onload="load()" >
		...
		<div id="content" style="visibility: hidden;">
			...
			<? if (file_exists('config.hosting.php') || @file_exists('../config.hosting.php')) {				
				@include ("mod/billingserver/inc_cpanel.billingserver.php");
			} ?>			
		</div>
	</body>
</html>