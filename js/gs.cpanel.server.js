		...
		case "server":
			...
			$.ajax({
				...
				{					
					...
					document.getElementById('cpanel_manage_server_map_arcgis').value = result['map_arcgis'];					
					...
					document.getElementById('cpanel_manage_server_map_arcgis_key').value = result['map_arcgis_key'];
					...
					document.getElementById('cpanel_manage_server_user_map_arcgis').value = result['user_map_arcgis'];
					...
					document.getElementById('cpanel_manage_server_kml').value = result['kml'];
					...
					document.getElementById('cpanel_manage_server_sim_number').value = result['sim_number'];
					document.getElementById('cpanel_manage_server_reports_schedule').value = result['reports_schedule'];
					document.getElementById('cpanel_manage_server_object_control_default_templates').value = result['object_control_default_templates'];
					...
					document.getElementById('cpanel_manage_server_billing_paypalv2_account').value = result['billing_paypalv2_account'];
					document.getElementById('cpanel_manage_server_billing_paypalv2_client_id').value = result['billing_paypalv2_client_id'];
					document.getElementById('cpanel_manage_server_billing_paypalv2_custom').value = result['billing_paypalv2_custom'];
					document.getElementById('cpanel_manage_server_billing_paypalv2_ipn_url').value = result['billing_paypalv2_ipn_url'];
...
function serverSave()
{
	...
	var map_arcgis = document.getElementById('cpanel_manage_server_map_arcgis').value;
	var map_yandex = document.getElementById('cpanel_manage_server_map_yandex').value;
	
	if ((map_osm == 'false') && (map_bing == 'false') && (map_google == 'false') && (map_mapbox== 'false') && (map_arcgis== 'false') && (map_yandex == 'false'))
	{
	...
	var user_map_arcgis = document.getElementById('cpanel_manage_server_user_map_arcgis').value;
	var user_map_yandex = document.getElementById('cpanel_manage_server_user_map_yandex').value;
	
	if ((user_map_osm == 'false') && (user_map_bing == 'false') && (user_map_google == 'false') && (user_map_mapbox== 'false') && (user_map_arcgis== 'false') && (user_map_yandex == 'false'))
	{
		notifyDialog(la['AT_LEAST_ONE_MAP_SHOULD_BE_ENABLED']);
		return;
	}
	...
	var items = {
		...
		map_arcgis_key: document.getElementById('cpanel_manage_server_map_arcgis_key').value,
		...
		sim_number: document.getElementById('cpanel_manage_server_sim_number').value,
		reports_schedule: document.getElementById('cpanel_manage_server_reports_schedule').value,
		object_control_default_templates: document.getElementById('cpanel_manage_server_object_control_default_templates').value,
		...
		billing_paypalv2_account: document.getElementById('cpanel_manage_server_billing_paypalv2_account').value,
		billing_paypalv2_client_id: document.getElementById('cpanel_manage_server_billing_paypalv2_client_id').value,
		billing_paypalv2_custom: document.getElementById('cpanel_manage_server_billing_paypalv2_custom').value,		
...
function serverCheck()
{
	...
	if (document.getElementById('cpanel_manage_server_billing_gateway').value == 'paypalv2')
	{
		document.getElementById('cpanel_manage_server_billing_paypalv2').style.display = '';
	...
	else if (document.getElementById('cpanel_manage_server_billing_gateway').value == 'paypal')
	{
		document.getElementById('cpanel_manage_server_billing_paypalv2').style.display = 'none';
