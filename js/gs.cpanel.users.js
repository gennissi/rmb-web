...
{
	var username = document.getElementById('dialog_subaccounts_subaccount_list_grid_username_' + id).value;
	var email = document.getElementById('dialog_subaccounts_subaccount_list_grid_email_'+ id ).value;
	var password = document.getElementById('dialog_subaccounts_subaccount_list_grid_password_'+ id ).value;
...
{
    var subaccounts = $('#dialog_subaccounts_subaccount_list_grid').jqGrid ('getGridParam', 'selarrrow');
...
function userEdit(cmd)
{
	switch (cmd)
	{
		default:
			...
			$.ajax({
				...
				{					
					...
					document.getElementById('dialog_user_edit_account_map_arcgis').value = privileges['map_arcgis'];
					$("#dialog_user_edit_account_map_arcgis").multipleSelect('refresh');					
					...
					document.getElementById('dialog_user_edit_account_kml').value = privileges['kml'];
					$("#dialog_user_edit_account_kml").multipleSelect('refresh');		
					...
					document.getElementById('dialog_user_edit_account_tachograph').value = privileges['tachograph'];
					...
					document.getElementById('dialog_user_edit_usage_webhook_daily').value = result['usage_webhook_daily'];
		...
		case "save":
			...
			var map_arcgis = document.getElementById('dialog_user_edit_account_map_arcgis').value;
			...
			var kml = strToBoolean(document.getElementById('dialog_user_edit_account_kml').value);
			...
			var tachograph = strToBoolean(document.getElementById('dialog_user_edit_account_tachograph').value);
			...
			var usage_webhook_daily = document.getElementById('dialog_user_edit_usage_webhook_daily').value;
